package com.example.asuspc.imperialroom;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.example.asuspc.imperialroom.Topbar topbar=(com.example.asuspc.imperialroom.Topbar)findViewById(R.id.topbar);
        topbar.setOnTopbarClickListener(new com.example.asuspc.imperialroom.Topbar.topbarClickListener() {
            @Override
